(function () {
    ...
    function boot () {
        ...
        var bundledScript = settings.debug ? 'src/project.dev.45444.js' : 'src/project.js';
        if (jsList) {
    ...
    if (window.jsb) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.0155c.js' : 'cocos2d-js-min.js';
